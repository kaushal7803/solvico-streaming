...
const WatchListSvg = ({ className }) => {
    return (
        <svg className={className} width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M2.5 11C1.99997 17 4.99998 20.5 8.49998 21.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
            <path d="M14.6618 10.8707C15.4461 11.3726 15.4461 12.6274 14.6618 13.1293L12.0147 14.8233C11.2304 15.3253 10.25 14.6979 10.25 13.694L10.25 10.306C10.25 9.30214 11.2304 8.67473 12.0147 9.17665L14.6618 10.8707Z" stroke="currentColor" stroke-width="1.5" />
        </svg>
